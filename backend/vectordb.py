...
class ChromaDatabase:
    def __init__(self, collection_name="image_embeddings"):
        """
    ...
    def store_image_in_db(self, image_path: str):
        """
    Stores an image embedding in the Chroma vector database.

    Args:
    - image_path (str): Path to the image file.
    - collection (chromadb.Collection): The Chroma collection to store the image in.
    """
        image_embedding = CLIPEmbedding.embed_image(image_path)
    ...
    def query_with_text(self, query_text=None, top_k=5):
        ...
        text_embedding = CLIPEmbedding.embed_text(query_text)
    ...
    def query_with_image(self, query_image=None, top_k=5):
        """
            ...
            Args:
                query_image (PIL.Image or numpy.ndarray): Path of the image to search for similar image, Defaults to None.
        ...
        image_embedding = CLIPEmbedding.embed_image(query_image)
